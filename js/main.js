const headerSearch = document.querySelector('.header_inner-right .fa-search');
const headerInput = document.querySelector('.search_input');
const headerInputClose = document.querySelector('.search_input span');
const secondLinks = document.querySelectorAll('.menu_second-link>a');
const mobMenuLinks = document.querySelectorAll('.nav_mobile-content>ul>li>a');
const navMobileContent = document.querySelector('.nav_mobile-content');
const mobMenudBack = document.querySelector('.menu_close-wrapper span');
const menu = document.querySelector('.menu');
const menuThirds = document.querySelectorAll('.menu_third');
const windowWrapper = document.querySelector('.window_wrapper');
const navMobile = document.querySelector('.nav_mobile');
const menuClose = document.querySelector('.menu_close');
const desktopLinks = document.querySelectorAll('.nav ul li');
const body = document.querySelector('body');
const header = document.querySelector('.header');
const thirdLinks = document.querySelectorAll('.menu_third ul li a');
const menuSeconds = document.querySelectorAll('.menu_second');
const headerBottom = document.querySelector('.header_bottom');
const headerBottomInner = document.querySelector('.header_bottom-inner');
const mobMenuSeconds = document.querySelectorAll('.mob_menu-second');
const mobSecondLinks = document.querySelectorAll('.mob_menu-second-link-wrapper>li>a')
const mobThirdLinks = document.querySelectorAll('.mob_menu-third ul li a')
...
menuClose.addEventListener('click', () => {
    ...
    const navMobContenFullRight = document.querySelector('.nav_mobile-content.half_right.full_right');
    const navMobContentHalfRight = document.querySelector('.nav_mobile-content.half_right');
    setTimeout(function () {
        if (navMobContenFullRight || navMobContentHalfRight) {
